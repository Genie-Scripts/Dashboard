...
# 2026-09-08(案3): move に calib（校正用生入力=retention/na/na_tgt/sv/surg_tgt/scores）を
# 追加。leveling スコアが room_per_week の相対順位から retention の目標比絶対不足率
# （_leveling_gap_score）へ統一されたことに伴う新規キー（本文/action・topic選定結果は
# フィクスチャの値がたまたま新旧どちらの式でも同じ主トピックになるため不変）。
_GOLDEN = [
 {"axis": "dept", "type_key": "internal", "order": 0, "unit": "循環器内科",
  ...
  "move": {"body": "LEVAI::循環器内科", "action": "LEVAI-ACT::循環器内科",
           ...
           "ai_body": "LEVAI::循環器内科", "ai_action": "LEVAI-ACT::循環器内科", "turn_line": '回転：在院 —／目標—・新入院/日 —／必要—（あと—）・在院日数 —日（参考）', "turn_state": 'hold', "turn_hint": '回転は維持。期間III超えを減らす（退院日未確定を毎朝確認）',
           "calib": {"retention": 0.85, "na": None, "na_tgt": None, "sv": None,
                     "surg_tgt": None,
                     "scores": {"leveling": 0.08602150537634412, "admission": 0.0}}}},
 {"axis": "dept", "type_key": "internal", "order": 1, "unit": "呼吸器内科",
  ...
  "move": {"body": "ADM::呼吸器内科",
           ...
           "nadm_line": "新入院：直近7日 5人／週目標20（25%）。28日線は—／あと約15人/週で目標", "turn_line": '回転：在院 —／目標—・新入院/日 —／必要—（あと—）・在院日数 —日（参考）', "turn_state": 'hold', "turn_hint": '回転は維持。期間III超えを減らす（退院日未確定を毎朝確認）',
           "calib": {"retention": 0.9, "na": 5, "na_tgt": 20, "sv": None,
                     "surg_tgt": None,
                     "scores": {"leveling": 0.032258064516129004, "admission": 0.75}}}},
 {"axis": "dept", "type_key": "surgical", "order": 2, "unit": "整形外科",
  ...
  "move": {"body": "SURG::整形外科", "action": "SURG-ACT::整形外科", "src": "ai",
           ...
           "surg_line": "全麻：直近7日 1件／週目標10（10%）。28日線は—／あと約9件/週で目標", "turn_line": '回転：在院 —／目標—・新入院/日 —／必要—（あと—）・在院日数 —日（参考）', "turn_state": 'hold', "turn_hint": '回転は維持。期間III超えを減らす（退院日未確定を毎朝確認）',
           "calib": {"retention": 0.95, "na": None, "na_tgt": None, "sv": 1,
                     "surg_tgt": 10,
                     "scores": {"leveling": 0.0, "admission": 0.0, "surgery": 0.9}}}},
 {"axis": "dept", "type_key": "internal", "order": 3, "unit": "消化器内科",
  ...
  "move": {"body": "週末も平日とほぼ同じ在院を保てています。今の入退院のリズムが手本になっています。",
           ...
           "ai_action": "週末の入退院リズムはこのまま継続しつつ、在院水準のさらなる底上げを図りましょう。", "turn_line": '回転：在院 —／目標—・新入院/日 —／必要—（あと—）・在院日数 —日（参考）', "turn_state": 'hold', "turn_hint": '回転は維持。期間III超えを減らす（退院日未確定を毎朝確認）',
           "calib": {"retention": 0.98, "na": None, "na_tgt": None, "sv": None,
                     "surg_tgt": None,
                     "scores": {"leveling": 0.0, "admission": 0.0}}}},
 {"axis": "dept", "type_key": "internal", "order": 4, "unit": "腎臓内科",
  ...
  "move": {"body": "手動本文差し替え", "action": "手動一手差し替え", "topic": "leveling",
           ...
           "ai_body": "LEVAI::腎臓内科", "ai_action": "LEVAI-ACT::腎臓内科", "turn_line": '回転：在院 —／目標—・新入院/日 —／必要—（あと—）・在院日数 —日（参考）', "turn_state": 'hold', "turn_hint": '回転は維持。期間III超えを減らす（退院日未確定を毎朝確認）',
           "calib": {"retention": 0.8, "na": None, "na_tgt": None, "sv": None,
                     "surg_tgt": None,
                     "scores": {"leveling": 0.13978494623655913, "admission": 0.0}}}},
 {"axis": "ward", "type_key": "ward", "order": 0, "unit": "04A",
  ...
  "move": {"body": "EMLEV::04A", "action": "EMLEV-ACT::04A", "src": "ai",
           ...
           "ai_body": "EMLEV::04A", "ai_action": "EMLEV-ACT::04A", "turn_line": '回転：在院 —／目標—・新入院/日 —／必要—（あと—）・在院日数 —日（参考）', "turn_state": 'hold', "turn_hint": '回転は維持。期間III超えを減らす（退院日未確定を毎朝確認）',
           "calib": {"retention": 0.7, "na": None, "na_tgt": None, "sv": None,
                     "surg_tgt": None,
                     "scores": {"leveling": 0.24731182795698925, "admission": 0.0}}}},
 {"axis": "ward", "type_key": "ward", "order": 1, "unit": "09B病棟",
  "total_retention_pct": 80.0,
  "charts": [{"kind": "A", "priority": 1}],
  "move": {"body": "LEVAI::09B病棟", "action": "LEVAI-ACT::09B病棟", "src": "ai",
           "topic": "leveling", "delta": None,
           "ai_body": "LEVAI::09B病棟", "ai_action": "LEVAI-ACT::09B病棟", "turn_line": '回転：在院 —／目標—・新入院/日 —／必要—（あと—）・在院日数 —日（参考）', "turn_state": 'hold', "turn_hint": '回転は維持。期間III超えを減らす（退院日未確定を毎朝確認）',
           "calib": {"retention": 0.75, "na": None, "na_tgt": None, "sv": None,
                     "surg_tgt": None,
                     "scores": {"leveling": 0.19354838709677424, "admission": 0.0}}}},
 {"axis": "ward", "type_key": "ward", "order": 2, "unit": "10A病棟",
  ...
  "move": {"body": "ADM::10A病棟 なお、週末在院の維持率は目標を明確に下回っている状況です。",
           ...
           "ai_action": "ADM-ACT::10A病棟", "turn_line": '回転：在院 —／目標—・新入院/日 —／必要—（あと—）・在院日数 —日（参考）', "turn_state": 'hold', "turn_hint": '回転は維持。期間III超えを減らす（退院日未確定を毎朝確認）',
           "calib": {"retention": 0.6, "na": 5, "na_tgt": 20, "sv": None,
                     "surg_tgt": None,
                     "scores": {"leveling": 0.3548387096774194, "admission": 0.75}}}},
]
