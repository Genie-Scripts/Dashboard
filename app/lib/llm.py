...
環境変数（deploy.sh と一元管理）:
    OMLX_MODEL     使用モデル（既定: gemma-4-26B-A4B-it-MLX-8bit）
...
def _resolve_default_model() -> str:
    ...
    try:
        ...
        pass
    return os.environ.get("OMLX_MODEL", "gemma-4-26B-A4B-it-MLX-8bit")  # 2026-08-13 ハブoverride実効値へ同期（deploy.sh・orchestrator dashboard fallback と同値）
