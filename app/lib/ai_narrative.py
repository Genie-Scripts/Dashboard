...
{"body":"新入院が目標を明確に下回り、足元でも弱含みが続いています。","action":"地域医療連携での紹介受け入れを重点化し、予定入院枠の前倒しも検討しましょう。"}"""
...
{"body":"全身麻酔手術は目標をやや下回るものの、直近は上向きつつあります。","action":"手術枠の稼働状況を確認し、執刀医と症例調整を進めてこの流れを後押ししましょう。"}
